            ...
            notification.open({
                message: (
                    <div className="text-center">
                        <a target="_blank" rel="noreferrer" href="https://github.com/arsalanarghavan/laravel-resume">
                ...
                description: <React.Fragment>
                    <Space direction="vertical" size="middle">
                        <div className="text-center">
                            Show your ❤️ and support by giving a ⭐️ on <a target="_blank" rel="noreferrer" href="https://github.com/arsalanarghavan/laravel-resume">GitHub</a>.
                        </div>
                        <div className="text-center">
